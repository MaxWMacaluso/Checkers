...
QT_MOC_LITERAL(1, 7, 11), // "SRightClick"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7), // "Square*"
QT_MOC_LITERAL(4, 28, 1), // "c"
QT_MOC_LITERAL(5, 30, 10) // "SLeftClick"

    },
    "Square\0SRightClick\0\0Square*\0c\0SLeftClick"
};
...
void Square::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SRightClick((*reinterpret_cast< Square*(*)>(_a[1]))); break;
        case 1: _t->SLeftClick((*reinterpret_cast< Square*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Square::SRightClick)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Square::*)(Square * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Square::SLeftClick)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Square::SRightClick(Square * _t1)
{
...
// SIGNAL 1
void Square::SLeftClick(Square * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
